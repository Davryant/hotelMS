    ...
    <div class="col-lg-7">
        ...
        <div class="card pd-20 pd-sm-40 mg-t-10" id="printa">
            ...
            <div style="margin-left:10%;margin-right:20px;" class="juujuu">
                ...
                <p style="padding : 0;margin : 0;line-height : 20px;">Time: <span style="text-decoration: underline; font-weight:bold; margin-bottom:-10px !important">20:21 AM</span> <span style="margin-left: 30%" id="date">Date: </span> {{ $muda[0] }} <span style="text-decoration: underline; font-weight:bold"></span> </p>
                <p style="padding : 0;margin : 0;line-height : 20px;">Waiter: <span style="text-decoration: underline; font-weight:bold; margin-bottom:-10px !important">{{ Auth::user()->name }}</span> <span style="margin-left: 30%" id="date">Table No:</span> <span style="text-decoration: underline; font-weight:bold">{{ $table_no[0] }}</span> </p>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <a name="" id="" class="btn btn-primary mg-l-10" href="#" role="button">{{ $room->room_name }}</a>
                @endforeach
            </div>
        </div>
    </div>
