            ...
            <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-md-6">
                            <a href="/acc/service/customer-view/{{ $customer->customer_id }}/report" class="btn btn-info btn-icon mg-r-5 mg-b-10" title="View Details"><div><i class="fa fa-eye"></i></div></a>
                             </div>
                        </div>
                      </td>
                  </tr>
