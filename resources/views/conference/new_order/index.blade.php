    ...
    <div class="card pd-20 pd-sm-40 mg-t-1">
        ...
        <div class="row">
            ...
            <div class="col-md-2 pull-right">
                <a href="/confe/service/new" class="btn btn-primary pull-right">New Order</a>
            </div>
        </div>
          ...
          <table id="datatable1" class="table display responsive nowrap">
            ...
            <tbody>
                  ...
                  <tr>
                      ...
                      <td style="width:10%">TZS {{ number_format(floatval($customer->conference_price), 0) }} </td>
                      <td style="width:10%">TZS {{ number_format(floatval($customer->amount_paid), 0) }} </td>
                      <td style="width:10%">TZS {{ number_format(floatval($customer->amount_paid - $customer->conference_price),0 ) }}</td>
