...
@endif
    ...
    <form action="/acc/service/customer-store" method="POST" novalidate>
        @csrf
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <input class="form-control" type="email" name="email"  placeholder="Enter email address" autocomplete = "off">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-3">
              ...
              <div class="col-lg-3">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control type select2"  name="customer_type" data-placeholder="Choose Customer Type" onChange="filter_customer_type()" required autocomplete = "off">
              ...
              <div class="col-lg-3">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control rooms select2" name="room_id" data-placeholder="Choose Room Name" onChange="filter_room_price()" required autocomplete = "off">
                    <option label="Choose Room Name"></option>
                  </select>
                </div>
              </div><!-- col-4 -->
             ...
             <div class="col-lg-5">
                <div class="form-group mg-b-10-force">
                  ...
                  <input class="form-control price" type="text" name="room_price_applied" value="" readonly>
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-3 mg-t-5 mg-lg-t-0">
                  <div class="form-group">
        ...
        function filter_room(){
          ...
          $.ajax({
            ...
            success: function(response) {
               ...
               $(".rooms").empty()
               $(".rooms").append('<option value="">-Choose Room Name-</option>');
