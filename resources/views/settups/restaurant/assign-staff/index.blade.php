                    ...
                    <div class="form-layout">
                      <div class="row mg-b-15">
                          <div class="col-lg-12 mg-t-5 mg-lg-t-0">
                              ...
                              <select class="form-control select2" name="restaurant_name" data-placeholder="Choose Restaurant Name">
                                  {{-- @foreach ($features as $feature)
                                   <option value="{{ $feature->id }}">{{ $feature->feature }}</option>
                                  @endforeach --}}
                                  <option value="" label="Choose Restaurant Name">--Choose Restaurant Name--</option>
