                          ...
                          <div class="row mg-b-25">
                            <div class="col-lg-12">
                              <div class="form-group">
                                <label class="form-control-label">Meal Type: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="meal_type" placeholder="Enter Meal Type name" autofocus>
                              </div>
                            </div><!-- col-4 -->
                          </div>
      ...
      <div class="card bd-0">
          ...
          <div class="card-body bd bd-t-0 rounded-bottom">
              <table id="datatable1" class="table display responsive nowrap">
                  <thead>
                    <tr>
                      <th class="wd-15p">Meal Type</th>
                      <th class="wd-15p">Meal Type code</th>
