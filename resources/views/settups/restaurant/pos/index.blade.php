...
<div class="card pd-10 pd-sm-10 mg-t--10 shotbutton">
    <div class="row">
        <div class="col-md-10">
            <ul id="cate">
        ...
        <div class="col-md-2">
            ...
            <button type="button" class="btn btn-info open-shift" onclick="openShift()"><i class="fa fa-lock"
                style="font-size: 50px; cursor: pointer;"></i><br>
            <p style="display: inline-block; font-size: 12px; margin-bottom: 0px ">Open Shift </p>
        </button> 
    ...
    <div class="col-lg-8">
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="row row-sm mg-t-0">
                <a href="/rest/bill/create" class="top-menu">
                    <button type="button" class="btn btn-danger">
                        <p style="display: inline-block; font-size: 12px; margin-bottom: 0px "> View KOT</p>
                    </button>
                </a>
                <a href="/rest/bill/create" class="top-menu mg-l-10">
                    <button type="button" class="btn btn-danger">
                        <p style="display: inline-block; font-size: 12px; margin-bottom: 0px "> Create Bill</p>
                    </button>
                </a>
                <a href="/rest/bill/create" class="top-menu mg-l-10">
                    <button type="button" class="btn btn-danger">
                        <p style="display: inline-block; font-size: 12px; margin-bottom: 0px "> View Bill</p>
                    </button>
                </a>
            </div>
    ...
    <div class="col-lg-4">
        <div class="card pd-20 pd-sm-40 choicesBoard">
            <div class="row customer-board">
                <div class="col-lg-10">
                    <select class="form-control select2 customer" data-placeholder="Choose Browser">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mg-t-5 mg-r--5 pull-right">
                    @csrf
                    <button type="submit" class="btn btn-primary btn-block mg-b-10 send-ticket"><i class="fa fa-send mg-r-10"></i> Send
                        KOT</button>
                </div>
            </div>
        </div>
...
@endsection
@section('script')
@include('settups.restaurant.pos.ourjs')

<script>

    function openShift(){
             swal("Your about to open shift, Cash in hand:", {
            content: "input",
            })
            .then((value) => {
