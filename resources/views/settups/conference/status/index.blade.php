...
@endsection
   ...
   <div class="row">
    @include('settups.conference.side-bar')  
    <div class="col-lg-3">
        <div class="card bd-0 mg-b-10">
          <div class="card-header card-header-default bg-info">
            Add Confernece Status
          </div><!-- card-header -->
                    ...
                    <div class="row mg-b-25">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label">Conference Status: <span class="tx-danger">*</span></label>
                          <input class="form-control" type="text" name="conference_status" placeholder="Enter Conference Status" autofocus>
                        </div>
                      </div><!-- col-4 -->
                    </div>
