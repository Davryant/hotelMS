    ...
    <div class="col-lg-12">
        <div class="card bd-0 mg-b-10">
            ...
            <div class="card-body bd bd-t-0 rounded-bottom">
                ...
                <form id="formadd" action="/settup/store/item"  method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 mg-t-5 mg-lg-t-0">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="cat_id" name="cat_id"
                                            data-placeholder="Choose Category Name">
                                            @foreach ($cats as $cat)
...
<script>
   ...
   $('#datatable1').Tabledit({
            url:'{{ route("itemEdit.action") }}',
            dataType:"json",
            columns:{
                identifier:[0, 'item_number'],
                editable:[[1,'item_name']]
            },
            restoreButton:false,
