...
<script>
    $(document).ready(function() {
        ...
        $('#editable').Tabledit({
            url:'{{ route("issueEditList.action") }}',
            dataType:"json",
            columns:{
                identifier:[0, 'issue_number'],
                editable:[[1, 'issued_to', '{"Bar":"Bar", "Restaurant":"Restaurant","Kitchen":"Kitchen", "Conference":"Conference","House Keeping":"House Keeping", "Restaurant":"Restaurant"}'], [2,'item_name'], [3,'item_quantity']]
            },
            restoreButton:false,
